...
%>
   ...
   <div class="btn">
      <input class="update" type="button" value="수정하기" onclick="location.href='Member_Update_List.jsp'">&nbsp;&nbsp;&nbsp;&nbsp;
      <input class="delete" type="button" value="탈퇴하기" onclick="location.href='Member_Delete_List.jsp'">
   </div>
	</div>
